[app](../../../index.md) / [com.example.mymovies.screens.watchlist](../../index.md) / [WatchlistAdapter](../index.md) / [WatchlistListener](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `WatchlistListener(clickListener: (imdbId: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`) -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`)`<br>If an item was clicked, the WatchlistListener sends the imdbId of that item |
