...
import com.example.mymovies.databinding.WatchlistViewItemBinding
import com.example.mymovies.models.MovieSerieDetail

/**
 * Responsible for binding each item of the [RecyclerView] that represents the watchlist
 */
class WatchlistAdapter(val clickListener: WatchlistListener, val removedListener: RemoveListener) :
    ListAdapter<MovieSerieDetail, WatchlistAdapter.ViewHolder>(DiffCallback) {

    /**
     * Describes an item view and metadata about its place within the RecyclerView.
     */
    class ViewHolder private constructor(val binding: WatchlistViewItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(
            item: MovieSerieDetail,
            clickListener: WatchlistListener,
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = WatchlistViewItemBinding.inflate(layoutInflater, parent, false)
     ...
     */
    class WatchlistListener(val clickListener: (imdbId: String) -> Unit) {
